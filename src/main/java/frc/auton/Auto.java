...
public class Auto extends TemplateAuto implements Runnable { 
    ...
    public void run() {
        ...
        p1.addPoint(new Translation2D(120, 54), 40);
        p1.addPoint(new Translation2D(234 - Constants.BumperWidth, 138), 40);
        ...
        p2.addPoint(new Translation2D(Constants.BumperWidth, 138), 40);
