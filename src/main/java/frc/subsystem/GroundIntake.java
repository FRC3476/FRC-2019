...
public class GroundIntake extends Threaded {
	...
	public void update() {
		...
		switch (snapIntake) {
			case INTAKE:
				intakeMotor.set(ControlMode.PercentOutput, Constants.IntakeMotorPercentOutputIntake);
				break;
			case OUTTAKE:
				intakeMotor.set(ControlMode.PercentOutput, Constants.IntakeMotorPercentOutputOuttake);
				break;
			case NEUTRAL:
